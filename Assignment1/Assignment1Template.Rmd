...
Due date: Mon 27/3/2023 at 23:59
...
```{r}
init_F_matrix <- function(A, B, gap) {
...
```{r, trace_back}
# 
trace_back <- function(F, A, B, gap, match, mismatch) {
...
```{r, global_alignment}
### 1st test
rs <- trace_back(Fmat, x, y, gap, match, mismatch)
cat("y: ", rs$AlignmentB, "\nx: ", rs$AlignmentA, "\n\n")
