...
__Question 3 :__ Why are those two parsimony scores same? Assuming all possible trees give different parsimony scores, which tree should be the maximum parsimony tree?
