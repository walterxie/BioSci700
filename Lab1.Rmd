...
1. Use the R code that you have learnt to choose the "best" model for this data. 


2. Use the software [PhyML](https://github.com/stephaneguindon/phyml) to create 
the maximum likelihood tree by using the model that you choose in the 1st step. 
