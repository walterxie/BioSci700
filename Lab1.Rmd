...
If you want to root the tree, one simple method is to use the function `root` and specify the outgroup taxon "Mouse". 
...
Then find the "best-fitting root" and attach the visualized tree in the report.
...
4. Write a full report to describe your analysis and explain the result, including the required answers from previous steps.
