...
1) plot the maximum parsimony tree using SPR search
and 2) choose the "best" model for this data. 
Please attach your R code in the report.

Tips: the alignment read from `read.FASTA` cannot be regonised by `modelTest`. 
You need to use the function `phyDat`.
